import 'package:lucas_app/modules/tasks/services/task_service.dart';
import 'package:lucas_app/modules/tasks/widgets/list_task.dart';
    ...
    return Scaffold(
        ...
        body: FutureBuilder<List<Task>>(
            ...
            builder: (context, snapshot) {
              ...
              return const Center(child: Text("Listagem de tarefas."));
            }));
  }
}
