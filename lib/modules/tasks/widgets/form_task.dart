...
import 'package:lucas_app/modules/tasks/styles/styles_task.dart';
    ...
    return Column(
      children: [
        ...
        TextFormField(
            ...
            readOnly: true,
            decoration: const InputDecoration(
                labelText: "Data da tarefa", icon: Icon(Icons.calendar_month)),
            onTap: () async {
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
              icon: Icon(Icons.description), labelText: "Detalhes da tarefa"),
          maxLines: 2,
        ),
